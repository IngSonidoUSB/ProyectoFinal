...
public class MainMenuScript : MonoBehaviour 
{
	...
	private void OnGUI()
	{
		...
		GUI.Box(new Rect(Screen.width/4, Screen.height/4, Screen.width/2, Screen.height/2), "MENU PRINCIPAL");
		
		if (GUI.Button(new Rect(Screen.width/4+10, Screen.height/4+Screen.height/10+10, Screen.width/2-20, Screen.height/10), "JUGAR")){
